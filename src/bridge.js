...
// single registry for reserved keys and strip walkers (SPEC §2 "Reserved
// envelope keys"). Re-exported here for backward compatibility; new code
// should import from `core/envelope.js` directly.
export {
  RESERVED_ENVELOPE_KEYS,
  EGRESS_STRIP_KEYS,
  MAX_STRIP_DEPTH,
